...
?>
	<div id='main'>
		<form id='login' class='form'>
			...
			<div class='encap'><p id='Email' class='form_tag'>Email</p><input class='form_input' type='text' name='email'></div>
			<div class='encap'><p id='pword' class='form_tag'>Password</p><input class='form_input' type='password' name='password'></div>
